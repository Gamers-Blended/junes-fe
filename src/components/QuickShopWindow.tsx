...
const QuickShopWindow: React.FC<QuickWindowProps> = ({
    ...
    const fetchProductDetails = async () => {
      try {
        ...
        if (data.productVariantDTOList.length > 0) {
          const { platform, region, edition } = itemVariantRef.current;
  ...
  useEffect(() => {
    if (!isLoading && productData) {
      console.log("Rendering quick shop content", {
        productData,
        productVariants,
      });
    }
  }, [isLoading, productData, productVariants]);
            ...
            <div className="product-info-section">
              ...
              <div className="product-details-table">
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-value">
                    {formatStringArrays(genres)}
                  </span>
                </div>
                <div className="detail-row">
                  <span className="detail-label">Number of Player(s)</span>
                  <span className="detail-value">
                    {formatNumberArrays(numberOfPlayers)}
                  </span>
                </div>
              </div>
...
export default React.memo(QuickShopWindow);
